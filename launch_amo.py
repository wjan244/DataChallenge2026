...
from src_amo.config import IMG_DIR, NUM_WORKERS, SUBMISSION_DIR
from src_amo.data.data_utils import get_challenge_split
from src_amo.data.dataset import Dataset as ChallengeDataset
...
METHOD_FT  = "clean_trainval_43"
MODEL_TAG  = f"{MODEL_NAME}_{METHOD_FT}"
TIMESTAMP  = datetime.now().strftime("%Y-%m-%d_%H-%M-%S")

SAVE_PATH        = Path("checkpoints/clean_trainval_43_final.pt")   # état final phase 2
PHASE1_SAVE_PATH = Path("checkpoints/clean_trainval_43_phase1.pt")  # état final phase 1
